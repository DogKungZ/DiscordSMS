...
token = "OTU2NTI0NTQwMjUzNTg1NDkw.Yjxe5Q.ICB_H1Nj1Z-ysOABft6AHlO7mJQ"
...
async def sms(ctx, phone, amount:int):
    ...
    if (amount < 151):
      ...
      embes = discord.Embed(title="Spam SmS", description="TAESMS",color=0xff4612)
...
@bot.command()
async def help(ctx):
	emBed = discord.Embed(title="TAESMS",description="วิธิใช้",color=0xff4612)
